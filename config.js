...
module.exports = {
	...
	BRANCH: 'master',
	STICKER_PACKNAME: process.env.STICKER_PACKNAME || '❤,  SPKings',
	ALWAYS_ONLINE: toBool(process.env.ALWAYS_ONLINE),
	LOG_MSG: toBool(process.env.LOG_MSG) || false,
	RMBG_KEY: process.env.RMBG_KEY || 'null',
	BAILEYS_LOG_LVL: process.env.BAILEYS_LOG_LVL || 'silent',
	LANG: (process.env.LANGUAG || 'de').toLowerCase(),
	...
	ANTILINK_MSG:
		process.env.ANTILINK_MSG || '_SPKings_\n*REGELBRUCH!!!*\nLink erkannt!\nBye &mention 👋',
	ANTISPAM_MSG:
		process.env.ANTISPAM_MSG || '_SPKings_\n*REGELBRUCH!!!*\nSpam erkannt!\nBye &mention 👋',
	ANTIWORDS_MSG:
		process.env.ANTIWORDS_MSG || '_SPKings_\n*REGELBRUCH!!!*\nGesperrtes Wort erkannt!\nBye &mention 👋',
